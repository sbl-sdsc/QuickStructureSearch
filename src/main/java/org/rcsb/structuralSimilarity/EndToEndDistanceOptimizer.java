...
import org.rcsb.fingerprints.EndToEndDistanceLinerarFingerprint;
 ...
 * @author  Peter Rose
 */
public class EndToEndDistanceOptimizer { 
	...
	public static void main(String[] args ) throws FileNotFoundException
	{
		...
		EndToEndDistanceOptimizer aaa = new EndToEndDistanceOptimizer();
...
//        	DCT1DOptFingerprint fp = new DCT1DOptFingerprint(r.nextInt());
 //       	DCT1DLinearFingerprint fp = new DCT1DLinearFingerprint(r.nextInt());
        	EndToEndDistanceLinerarFingerprint fp = new EndToEndDistanceLinerarFingerprint(r.nextInt());
