 ...
 * @author  Peter Rose
 */
public class LinearFeatureVectorToLevenshteinMapper implements PairFunction<Tuple2<Integer,Integer>,String,Float> {
	private static final long serialVersionUID = 1L;
	private Broadcast<List<Tuple2<String,Vector>>> data = null;


	public LinearFeatureVectorToLevenshteinMapper(Broadcast<List<Tuple2<String,Vector>>> data) {
		this.data = data;
	}
