...
public class SmithWatermanHL implements PairFunction<Tuple2<Integer,Integer>,String,Float> {
	...
	public SmithWatermanHL(Broadcast<List<Tuple2<String,Vector>>> data, int traceback) {
		this.data = data;
	...
	private void printTraceback(double[] v1,double[] v2,int[][] b) {
		int x = maxX;
		int y = maxY;
