...
* @author Joe Sun
*/
public class GapFilterSPC implements Function<Tuple2<String, SimplePolymerChain>, Boolean> {
	 ...
	 */
	public GapFilterSPC(int maxGapSize, int maxGapCount) {
		this.maxGapSize = maxGapSize;
		this.maxGapCount = maxGapCount;
	}

	@Override
	public Boolean call(Tuple2<String, SimplePolymerChain> tuple) throws Exception {
		Point3d[] points = tuple._2.getCoordinates();
