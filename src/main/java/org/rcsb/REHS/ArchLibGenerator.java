...
public class ArchLibGenerator {
	public static void main(String[] args) throws IOException {
		...
		String libFile = args[1] + "_" + timeStamp;
		System.out.println("Library file    : " + libFile);

		long start = System.nanoTime();

		int fragmentSize = 10;
		double rmsdThreshold = 4.75;

		getLibrary(chainFile, fragmentSize, rmsdThreshold, libFile);
...
/**
 * Reads text file generated by getAllFragments and returns the library as a list
 * @param filePath gets text file from this location
 * @return library as a List
