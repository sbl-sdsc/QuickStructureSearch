...
//        }
		...
		writer.println("PdbId.ChainId1, PdbId.ChainId2,start1,start2,cRMSD,cRMSD2,dRMSD,adRMSD,deltacRMSDdRMSD,cRMSDTime,dRMSDTime,adRMSDTime,cRMCSD2Time,len1,len2,deltaLen");
