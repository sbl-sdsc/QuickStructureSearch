 ...
 */
public class JaccardIndexMapperP3 implements AlignmentAlgorithmInterface {
	...
	public JaccardIndexMapperP3() {
	}

	public JaccardIndexMapperP3(Broadcast<Map<String,SequenceFeatureInterface<?>>> sequences) {
	...
	private <T> float jaccardIndex(SequenceFeatureInterface<T> s1, SequenceFeatureInterface<T> s2) {
		...
		return (float) JaccardIndex.jaccardIndex(features1, features2);
	}
