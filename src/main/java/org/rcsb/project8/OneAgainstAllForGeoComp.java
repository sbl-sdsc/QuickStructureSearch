 ...
 * @author Chris Li
 */
public class OneAgainstAllForGeoComp {
	private static int NUM_THREADS = 8;
	private static int NUM_TASKS_PER_THREAD = 3; // Spark recommends 2-3 tasks per thread
	private static int BATCH_SIZE = 25;
	private static double fingerPrintFilter = 0.15;
	...
	public static void main(String[] args ) throws FileNotFoundException
	{
		...
		OneAgainstAllForGeoComp o = new OneAgainstAllForGeoComp();
		long st = System.nanoTime();
		String[] testPros = {"4IFJ.A"};//{"3DMW.C","4IFJ.A", "1UH1.E"}; //"1A1R.D", "2DRX.C", 
