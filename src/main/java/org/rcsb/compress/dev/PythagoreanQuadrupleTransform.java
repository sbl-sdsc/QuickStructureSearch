...
public class PythagoreanQuadrupleTransform implements IntegerTransform, Serializable {
	private static final long serialVersionUID = 1L;
	private static int DISTANCE_MIN = 3750;
	private static int DISTANCE_MAX = 3850;
...
//		pythagoreanQuadruples = PythagoreanQuadruples.getReorderedQuadruples(DISTANCE_MIN, DISTANCE_MAX, iter);
	...
	public static void main(String[] args) {
		PythagoreanQuadrupleTransform transform = new PythagoreanQuadrupleTransform();
...
//			System.out.println("reverse: quad: " + Arrays.toString(quad));
			...
			int z = quad[3] - data[i + len+len+len];
			out[i] = x;
			out[i + len] = y;
			out[i + len + len] = z;
			}
