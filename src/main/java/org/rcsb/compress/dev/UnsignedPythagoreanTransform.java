...
public class UnsignedPythagoreanTransform implements IntegerTransform, Serializable {
...
//			System.out.println("x " + out[i] +  " xe: " + xe + " dx: " + dx + " udx: " + udx + " sdx: " + sdx);
			out[i] = sdx;
			out[i+len]= toUnsignedInt(out[i+len]);
			out[i+len+len]= toUnsignedInt(out[i+len+len]);
		}
