...
public class ArchLibGenerator {
	...
	public static void main(String[] args) {
		...
		String libraryFile = args[1] + File.separatorChar + "ArchetypeLibrary_" + timeStamp + ".csv";
	    System.out.println("Benchmark file: " + libraryFile);
		
	    long start = System.nanoTime();

		double fraction = 0.0002;
		int randomSeed = 1;
	    int combinations = run(chainFile, libraryFile, fraction, randomSeed);
