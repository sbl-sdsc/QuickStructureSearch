...
public class LibraryFingerprintSim implements SequenceFingerprint, Serializable {
	 ...
	 * 
	 */
	public LibraryFingerprintSim (List<Point3d[]> lib, double[][] rmsdArray, double rmsdThreshold) {
		this.library = lib;
