...
//		Set<String> mySet =new HashSet<String>();
	...
	//									System.out.println(label);
	    ...
	    System.out.println("BloomFilter nbits: " + filter.getNumberOfBits());
	    System.out.println("Maximal number of interactions per structure: " + maxInteraction);
	    System.out.println("BloomFilter contains: 9ARGFMNNEO2P: " + filter.contains("9ARGFMNNEO2P"));
	    System.out.println("BloomFilter contains: 1ARGFMNNEO2P: " + filter.contains("1ARGFMNNEO2P"));
	    System.out.println("BloomFilter contains: 10CYSSF4SGFE2: " + filter.contains("10CYSSF4SGFE2"));
	    System.out.println("BloomFilter contains: 9CYSSF4SGFE3: " + filter.contains("9CYSSF4SGFE3"));
